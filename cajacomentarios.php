        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                <li class="nav-item">
                  <a class="nav-link" href="indexUR.php"> Inicio </a>
                </li>
                          ...
                          <div class='comentario-superior'>
                              ...
                              <div class='contener-comentario'>
                                <div class='encabezado-comentario'>
                                  <h6 class='autor-comentario por-usuario'>$autorNuevo</h6>
                                </div>
                                <div class='contenido-comentario'>
                                  <form action='upload.php' method='POST' enctype='multipart/form-data'>
                                    <textarea name='comentario' cols='91' rows='7' placeholder='Añade una nueva queja/sugerencia'></textarea>
                                    <label for='fileToUpload'>Adjuntar media  <input type='file' name='fileToUpload'></label>
