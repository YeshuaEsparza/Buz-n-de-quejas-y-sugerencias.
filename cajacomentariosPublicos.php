      ...
      <div class="container-fluid">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href="indexUR.php">
            <span>
              Facultad de Ciencias de la Computación | Bienvenido Internauta
            </span>
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="empezar.php"> Iniciar sesi&oacute;n </a>
                </li>
                <li class="nav-item active">
                  <a class="nav-link" href="cajacomentariosPublicos.php"> Portal de comentarios </a>
                </li>
                <li class="nav-item">
            ...
            <div class="">
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                while (mysqli_more_results($link) && mysqli_next_result($link)) {
                  // Liberar el conjunto de resultados actual
                ...
                if ($respuesta == null) {
                  $respuesta = "Petición en proceso de revisión.";
                }
                ...
                if($fileType == "jpg" || $fileType == "jpeg" || $fileType == "png" || $fileType == "gif") {
                  echo "            
                                  <img src='media_comentarios/$media' alt='' width='180'>
                                </div>";
